  ...
  const GRID_TEMPLATE =
    "40px minmax(70px,.5fr) minmax(200px,1.6fr) minmax(160px,1.2fr) minmax(100px,.7fr) minmax(100px,.7fr) minmax(70px,.4fr) 80px";
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {IconComp && (
                              <IconComp size={15} style={{ color: C.navy, flexShrink: 0 }} />
                            )}
                            <span
                              style={{
                                fontSize: 13,
